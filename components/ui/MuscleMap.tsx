...
import Svg, {
  Path, Ellipse, Circle, G, Text as SvgText
...
interface MuscleConfig {
  primaryColor: string;    // Color cuando este músculo está activo
  secondaryColor: string;  // Músculos secundarios
...
const BASE_SKIN = '#2A2A2A';        // Cuerpo inactivo (dark mode)
const BASE_STROKE = '#444444';      // Contorno muscular
const BASE_OUTLINE = '#666666';     // Silueta exterior
const HIGHLIGHT = '#FF4D00';        // Primario (tu brand)
const HIGHLIGHT_SEC = '#FF8C5A';    // Secundario
const CARDIO_COLOR = '#378ADD';     // Para cardio/full body

// ─── Props ────────────────────────────────────────────────────────────────

interface MuscleMapProps {
  muscleId: number;
  /** Músculos secundarios activados (opcional) */
  secondaryMuscleIds?: number[];
  /** Tamaño del componente */
  size?: 'sm' | 'md' | 'lg';
  /** Mostrar etiqueta del músculo */
  showLabel?: boolean;
  /** Mostrar botón de voltear vista */
  showToggle?: boolean;
}
...
export default function MuscleMap({
  ...
  // Decide si este músculo debe resaltarse en la vista actual
  ...
  const getMuscleColor = (mId: number, defaultColor: string): string => {
    if (isPrimary(mId))   return HIGHLIGHT;
    if (isSecondary(mId)) return HIGHLIGHT_SEC;
    return defaultColor;
  };

  // FullBody / Cardio: todo resaltado
...
function FrontBody({ getMuscleColor, isFullBody, fullBodyColor, muscleId }: any) {
  ...
  return (
    <G>
      ...
      {/* Hombro izq */}
      <Path
        d="M30 22 Q26 20 24 26 Q22 32 26 35 L32 32 Z"
        fill={c(4, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      {/* Hombro der */}
      <Path
        d="M70 22 Q74 20 76 26 Q78 32 74 35 L68 32 Z"
        fill={c(4, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      ...
      {/* Pec izquierdo */}
      <Path
        d="M38 22 Q32 24 31 32 Q36 36 46 34 L46 22 Z"
        fill={c(1, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      {/* Pec derecho */}
      <Path
        d="M62 22 Q68 24 69 32 Q64 36 54 34 L54 22 Z"
        fill={c(1, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      ...
      {/* ── Bíceps ── */}
      <Path
        d="M26 35 Q22 42 24 50 L28 48 Q30 40 32 35 Z"
        fill={c(5, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      <Path
        d="M74 35 Q78 42 76 50 L72 48 Q70 40 68 35 Z"
        fill={c(5, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      ...
      {/* ── Antebrazos ── */}
      <Path
        d="M24 50 Q20 58 22 68 L26 66 Q28 56 28 48 Z"
        fill={c(7, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      <Path
        d="M76 50 Q80 58 78 68 L74 66 Q72 56 72 48 Z"
        fill={c(7, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      ...
      {/* ── Abdomen ── */}
      {/* Rectus abdominis - 3 pares */}
      {[0, 1, 2].map(i => (
        <G key={i}>
          <Path
            d={`M44 ${36 + i * 8} Q46 ${34 + i * 8} 50 ${35 + i * 8} L50 ${44 + i * 8} Q46 ${44 + i * 8} 44 ${44 + i * 8} Z`}
            fill={c(8, BASE_SKIN)}
            stroke={BASE_STROKE}
            strokeWidth="0.35"
          />
          <Path
            d={`M56 ${36 + i * 8} Q54 ${34 + i * 8} 50 ${35 + i * 8} L50 ${44 + i * 8} Q54 ${44 + i * 8} 56 ${44 + i * 8} Z`}
            fill={c(8, BASE_SKIN)}
            stroke={BASE_STROKE}
            strokeWidth="0.35"
          />
      ...
      {/* ── Oblicuos ── */}
      <Path
        d="M38 36 Q33 44 34 58 Q38 62 44 60 L44 36 Z"
        fill={c(9, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      <Path
        d="M62 36 Q67 44 66 58 Q62 62 56 60 L56 36 Z"
        fill={c(9, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      ...
      {/* ── Cadera / Pelvis ── */}
      <Path
        d="M34 60 Q32 64 34 68 Q42 72 50 72 Q58 72 66 68 Q68 64 66 60 L56 60 L44 60 Z"
        fill={BASE_SKIN}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      ...
      {/* ── Cuádriceps izq ── */}
      <Path
        d="M34 68 Q30 80 32 96 Q36 102 42 100 Q46 88 46 72 Z"
        fill={c(11, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      {/* División interna del cuádriceps izq */}
      <Path
        d="M40 70 Q38 84 38 98" stroke={BASE_STROKE} strokeWidth="0.25" fill="none" opacity="0.6"/>

      {/* ── Cuádriceps der ── */}
      <Path
        d="M66 68 Q70 80 68 96 Q64 102 58 100 Q54 88 54 72 Z"
        fill={c(11, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      <Path
        d="M60 70 Q62 84 62 98" stroke={BASE_STROKE} strokeWidth="0.25" fill="none" opacity="0.6"/>
      ...
      {/* ── Tibias / Espinillas ── */}
      <Path
        d="M33 107 Q30 120 31 134 Q35 138 38 136 Q42 122 44 108 Z"
        fill={c(13, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      <Path
        d="M67 107 Q70 120 69 134 Q65 138 62 136 Q58 122 56 108 Z"
        fill={c(13, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
...
function BackBody({ getMuscleColor, isFullBody, fullBodyColor, muscleId }: any) {
  ...
  return (
    <G>
      ...
      {/* ── Trapecio ── */}
      <Path
        d="M38 20 Q32 22 30 28 Q34 30 42 28 Q46 26 50 26 Q54 26 58 28 Q66 30 70 28 Q68 22 62 20 Q56 18 50 18 Q44 18 38 20 Z"
        fill={c(2, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />

      {/* ── Hombro posterior izq ── */}
      <Path
        d="M30 22 Q24 20 22 28 Q20 34 24 37 L30 34 Q32 28 34 24 Z"
        fill={c(4, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      {/* ── Hombro posterior der ── */}
      <Path
        d="M70 22 Q76 20 78 28 Q80 34 76 37 L70 34 Q68 28 66 24 Z"
        fill={c(4, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />

      {/* ── Espalda alta (dorsal + romboides) ── */}
      <Path
        d="M38 28 Q32 34 32 50 Q36 56 44 54 L46 28 Z"
        fill={c(2, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      <Path
        d="M62 28 Q68 34 68 50 Q64 56 56 54 L54 28 Z"
        fill={c(2, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      ...
      {/* ── Espalda baja (lumbar) ── */}
      <Path
        d="M36 54 Q32 60 34 68 Q42 72 50 72 Q58 72 66 68 Q68 60 64 54 L56 54 L44 54 Z"
        fill={c(3, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      ...
      {/* ── Tríceps izq ── */}
      <Path
        d="M24 37 Q20 44 22 52 L26 50 Q28 42 30 37 Z"
        fill={c(6, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      {/* ── Tríceps der ── */}
      <Path
        d="M76 37 Q80 44 78 52 L74 50 Q72 42 70 37 Z"
        fill={c(6, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      ...
      {/* ── Antebrazos ── */}
      <Path
        d="M22 52 Q18 60 20 70 L24 68 Q26 58 26 50 Z"
        fill={c(7, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      <Path
        d="M78 52 Q82 60 80 70 L76 68 Q74 58 74 50 Z"
        fill={c(7, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      ...
      {/* ── Glúteos ── */}
      <Path
        d="M34 68 Q30 76 32 86 Q38 92 48 90 L50 72 Z"
        fill={c(10, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      <Path
        d="M66 68 Q70 76 68 86 Q62 92 52 90 L50 72 Z"
        fill={c(10, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      ...
      {/* ── Isquiotibiales ── */}
      <Path
        d="M32 86 Q28 100 30 110 Q34 116 40 114 Q44 100 48 90 Z"
        fill={c(12, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      <Path
        d="M68 86 Q72 100 70 110 Q66 116 60 114 Q56 100 52 90 Z"
        fill={c(12, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      ...
      {/* ── Pantorrillas ── */}
      <Path
        d="M30 119 Q26 130 28 142 Q32 146 38 144 Q42 132 42 120 Z"
        fill={c(13, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
      <Path
        d="M70 119 Q74 130 72 142 Q68 146 62 144 Q58 132 58 120 Z"
        fill={c(13, BASE_SKIN)}
        stroke={BASE_STROKE}
        strokeWidth="0.4"
      />
